...
interface PopupProps {
  ...
  popupContent?: { text: string; id: string }; // Make popupContent optional
...
const Popup: React.FC<PopupProps> = ({ setShowPopup, popupContent, setUpdateUI }) => {
  const [input, setInput] = useState(popupContent?.text || ""); // Set input to popupContent.text if it's defined
